...
<%--
  ...
  resume side så kunden kan se de valgte ting iden kunden sender det vidre til fogmedarbejderen
--%>
<title>Kurv</title>
...
<table class="text-center mt-4" style="width:100%">
    ...
    <tr>
        ...
        <td></td>
        <td>
            <div class="mt-4"><h4>Pris i alt:</div>
            </h4>
        <td>
            <div class="mt-4"><h4>${sessionScope.totalPrice} kr.</div>
        </td>
        <td>
            <form class="mt-4" name="payOrder" action="FrontController" method="POST">
