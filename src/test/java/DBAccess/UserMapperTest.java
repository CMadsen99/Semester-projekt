...
//    (4,'someone@nowhere.com','sesam','customer');
    ...
    public void testLogin01() throws LoginSampleException {
        // Can we log in
        User user = UserMapper.login( "jens", "jens@somewhere.com", "jensen" );
    ...
    public void testLogin02() throws LoginSampleException {
        ...
        User user = UserMapper.login("jens", "jens@somewhere.com", "larsen" );
    }
    ...
    public void testCreateUser01() throws LoginSampleException {
        ...
        User original = new User("king king", "king@kong.com", "uhahvorhemmeligt", "kongsby", 0000, "kongevej 1", "konge" );
        UserMapper.createUser( original );
        User retrieved = UserMapper.login("king kong", "king@kong.com", "uhahvorhemmeligt" );
